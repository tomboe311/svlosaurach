        ...
        <header className="bg-white p-8">
            <div className="container mx-auto mb-20">
                ...
                <Typography variant="lead" className="mb-4 !text-gray-500 md:pr-16 xl:pr-28">
                    Mit insgesamt 16 Jugendmannschaften, davon fünf Mannschaften in einer Spielgemeinschaft mit dem TSV Markt Erlbach, bilden wir wichtige Basis für die Zukunft unserer Herren- und Frauenmannschaften. Ganz besonders stolz sind wir auch auf unsere vier Juniorinnen-Teams der Altersklassen U17, U13 und U11.
                </Typography>
            </div>
